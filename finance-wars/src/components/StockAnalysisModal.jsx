      ...
      >
        ...
        {loading && (
          <div style={{ textAlign: "center", padding: "40px", color: "#9ca3af" }}>
            <p>Loading real-time data from Yahoo Finance...</p>
          </div>
        )}
        ...
        {error && (
          <div style={{ textAlign: "center", padding: "20px", color: "#ef4444" }}>
            <p>⚠️ {error}</p>
            <p style={{ fontSize: "12px", marginTop: "10px" }}>Unable to fetch real market data. Please try another stock.</p>
          </div>
        )}
        ...
        {!loading && !error && chartData && (
          <>
            ...
            <h4 style={{ marginTop: '20px', color: '#e5e7eb' }}>5-Year Real Market Data</h4>
            <p style={{ fontSize: "14px", color: "#9ca3af" }}>
              This chart displays actual historical price data from Yahoo Finance.
              Analyze real market trends, volatility patterns, and returns to understand
